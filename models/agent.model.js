...
const agent_schema = new Schema(
  {
    ...
    available_for_work: { type: String, required: true },
    password: { type: String, required: true },
    address_verification_done: { type: Array, required: true }, //[date, verification_id, price]
    address_verification_count: { type: String, required: true },
    address_verification_amount_due: { type: String, required: true },
    address_verification_amount_paid: { type: String, required: true },
  },
  { timestamps: true },
);
